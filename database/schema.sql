...
CREATE TABLE students (
  ...
  academic_session VARCHAR(9) NOT NULL DEFAULT '2025-2026',
  ...
  name VARCHAR(190) NOT NULL,
  branch VARCHAR(190) NOT NULL DEFAULT 'Unspecified',
  mobile_number VARCHAR(20) NULL,
  address TEXT NULL,
  department_name VARCHAR(190) NOT NULL DEFAULT 'Unspecified',
  school_name VARCHAR(190) NOT NULL DEFAULT 'Unspecified',
  current_year_of_study TINYINT UNSIGNED NOT NULL DEFAULT 1,
  semester TINYINT UNSIGNED NULL,
  ...
  KEY idx_students_academic_session (academic_session),
  KEY idx_students_enrollment_number (enrollment_number),
